    ...
    return (
        <>
            ...
            <ol>
                ...
                <li>Initialize the database folder:<CodeBlock language={`bash`} code={`estate database init`}/></li>
                <li>Deploy the database backend code to Estate on the internet:<CodeBlock language={`bash`} code={`estate database boot`}/></li>
                <li>Generate client code to talk the database:<CodeBlock language={`bash`} code={`estate database connect`}/></li>
            ...
            <ol>
                ...
                <li>Consider the key takeaways:
                    <ul>
                        ...
                        <li><em>This was accomplished with only <a href={'https://github.com/estatejs/estate/examples/blob/main/exercise-tracker/database/index.ts'}> <b>105 lines</b></a> of backend code.</em></li>
                    </ul>
                </li>
            </ol>
        </>
